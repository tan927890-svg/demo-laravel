...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .svc-hero-inner { position: relative; z-index: 1; display: flex; flex-direction: column; gap: 14px; }
  .svc-breadcrumb { display: flex; align-items: center; gap: 8px; font-size: 12px; color: var(--gray-3); letter-spacing: .5px; }
  .svc-breadcrumb a { color: var(--gray-3); transition: color .2s; }
  .svc-breadcrumb a:hover { color: var(--white); }
  .svc-breadcrumb span { color: var(--white); }
  .svc-breadcrumb i { font-size: 9px; color: var(--gray-4); }
  ...
  .svc-hero p { font-size: 16px; color: var(--gray-3); max-width: 520px; line-height: 1.7; }
  .svc-hero-actions { display: flex; gap: 12px; margin-top: 6px; flex-wrap: wrap; }
  .btn-primary { display: inline-flex; align-items: center; gap: 8px; background: var(--blue); color: var(--white); font-size: 13px; font-weight: 600; letter-spacing: .8px; text-transform: uppercase; padding: 12px 28px; transition: background .2s; }
  .btn-primary:hover { background: #1555b0; color: var(--white); }
  .btn-secondary { display: inline-flex; align-items: center; gap: 8px; background: transparent; color: var(--white); font-size: 13px; font-weight: 600; letter-spacing: .8px; text-transform: uppercase; padding: 11px 28px; border: 1px solid rgba(255,255,255,.35); transition: border-color .2s; }
  .btn-secondary:hover { border-color: var(--white); color: var(--white); }

  /* ── STATS BAR — nền trắng, số đếm khi scroll ── */
  ...
  .stat-label { font-size: 12px; color: var(--gray-4); letter-spacing: 1px; margin-top: 6px; display: block; text-transform: uppercase; }
  ...
  .section-tag { font-size: 11px; font-weight: 700; letter-spacing: 3px; text-transform: uppercase; color: var(--blue); margin-bottom: 10px; display: block; }
  ...
  .section-sub { font-size: 15px; color: var(--gray-4); margin-top: 10px; max-width: 560px; line-height: 1.7; }
  ...
  .quick-nav-item { display: flex; align-items: center; gap: 8px; padding: 16px 24px; font-size: 13px; font-weight: 500; color: var(--gray-5); white-space: nowrap; border-right: 1px solid var(--gray-2); transition: background .18s, color .18s; }
  .quick-nav-item:hover, .quick-nav-item.active { background: var(--white); color: var(--blue); }
  .quick-nav-item i { font-size: 12px; color: var(--blue); }
  ...
  .svc-icon-box { width: 52px; height: 52px; flex-shrink: 0; background: #e8f0fe; border: none; display: flex; align-items: center; justify-content: center; border-radius: 8px; }
  .svc-icon-box img { width: 26px; height: 26px; object-fit: contain; }
  .svc-info { flex: 1; }
  .svc-info h3 { font-family: var(--font-h); font-size: 18px; font-weight: 700; text-transform: uppercase; color: var(--text); letter-spacing: .3px; margin-bottom: 6px; }
  .svc-info p { font-size: 13.5px; color: var(--gray-4); line-height: 1.7; margin-bottom: 14px; }
  .svc-link { font-size: 12px; font-weight: 700; letter-spacing: 1.5px; text-transform: uppercase; color: var(--blue); display: inline-flex; align-items: center; gap: 6px; transition: gap .2s; }
  ...
  /* ── QUICK SERVICE — không khung, hoà vào nền xám ── */
  .quick-svc-grid {
  ...
  .quick-svc-title { font-family: var(--font-h); font-size: 15px; font-weight: 700; text-transform: uppercase; color: var(--text); margin-bottom: 4px; }
  .quick-svc-desc { font-size: 13px; color: var(--gray-4); line-height: 1.6; }
  ...
  .process-step h4 { font-family: var(--font-h); font-size: 14px; font-weight: 700; text-transform: uppercase; letter-spacing: .5px; color: var(--text); margin-bottom: 8px; }
  .process-step p { font-size: 12.5px; color: var(--gray-4); line-height: 1.6; }
  ...
  .pkg-badge-label { display: inline-block; font-size: 10px; font-weight: 700; letter-spacing: 2px; text-transform: uppercase; padding: 4px 10px; background: var(--white); color: var(--blue); margin-bottom: 16px; }
  .pkg-card.highlight .pkg-badge-label { background: rgba(255,255,255,.2); color: var(--white); }
  .pkg-name { font-size: 11px; font-weight: 700; letter-spacing: 3px; text-transform: uppercase; color: var(--gray-4); margin-bottom: 6px; }
  ...
  .pkg-price-unit { font-size: 13px; color: var(--gray-4); margin: 4px 0 24px; }
  .pkg-card.highlight .pkg-price-unit { color: rgba(255,255,255,.6); }
  ...
  .pkg-features-list li { display: flex; align-items: flex-start; gap: 10px; font-size: 13.5px; color: var(--gray-5); padding: 8px 0; border-bottom: 1px solid var(--gray-2); }
  .pkg-card.highlight .pkg-features-list li { color: rgba(255,255,255,.85); border-bottom-color: rgba(255,255,255,.12); }
  .pkg-features-list li:last-child { border-bottom: none; }
  .pkg-features-list li i { color: var(--blue); margin-top: 3px; font-size: 11px; flex-shrink: 0; }
  .pkg-card.highlight .pkg-features-list li i { color: rgba(255,255,255,.85); }
  .btn-pkg-outline { display: block; text-align: center; font-size: 12px; font-weight: 700; letter-spacing: 1.5px; text-transform: uppercase; padding: 12px 20px; border: 1px solid var(--blue); color: var(--blue); transition: background .18s, color .18s; }
  .btn-pkg-outline:hover { background: var(--blue); color: var(--white); }
  .btn-pkg-white { display: block; text-align: center; font-size: 12px; font-weight: 700; letter-spacing: 1.5px; text-transform: uppercase; padding: 12px 20px; background: var(--white); color: var(--blue); transition: opacity .18s; }
  ...
  .cta-section::before { content: ''; position: absolute; inset: 0; background: url('https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=1400&q=80') center/cover no-repeat; opacity: .12; }
  .cta-inner { position: relative; z-index: 1; }
  .cta-section h2 { font-family: var(--font-h); font-size: clamp(32px,5vw,60px); font-weight: 800; text-transform: uppercase; color: var(--white); line-height: 1.1; margin-bottom: 16px; }
  .cta-section h2 span { color: var(--blue); }
  .cta-section p { font-size: 15px; color: var(--gray-3); max-width: 480px; margin: 0 auto 32px; line-height: 1.7; }
  ...
  <div class="container">
    ...
    <div class="pkg-grid">
      <div class="pkg-card">
        ...
        <div class="pkg-price-num">1.9<span style="font-size:24px;font-weight:600">tr</span></div>
        ...
        <a href="{{ url('/contact') }}" class="btn-pkg-outline">Đăng ký gói</a>
      </div>
      <div class="pkg-card highlight">
        <div class="pkg-badge-label">Phổ biến nhất</div>
        <div class="pkg-name">Gói Tiêu Chuẩn</div>
        <div class="pkg-price-num">3.9<span style="font-size:24px;font-weight:600">tr</span></div>
        <div class="pkg-price-unit">/ năm</div>
        <div class="pkg-divider"></div>
        <ul class="pkg-features-list">
        ...
        <a href="{{ url('/contact') }}" class="btn-pkg-white">Đăng ký ngay</a>
      </div>
      <div class="pkg-card">
