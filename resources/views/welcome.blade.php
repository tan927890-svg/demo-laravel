...
<html lang="en">
   ...
   <body>
      ...
      <section class="welcome-block objects-car page-section-ptb white-bg portfolio-main">
         {{-- BƯỚC 1: Xóa 2 dòng này trong section welcome-block --}}
{{-- <div class="objects-left left"><img class="img-responsive objects-1" src="{{ asset('images/objects/01.png') }}" alt=""></div> --}}
{{-- <div class="objects-right right"><img class="img-responsive objects-2" src="{{ asset('images/objects/02.png') }}" alt=""></div> --}}

{{-- BƯỚC 2: Thêm đoạn này vào NGAY TRƯỚC thẻ đóng </section> của welcome-block --}}
                  ...
                  <div class="owl-carousel-1">
                     <div class="item">
                        <div class="car-item text-center">
                           <div class="car-image">
                              <img class="img-responsive" src="{{ asset('images/car/02.jpg') }}" alt="" />
                     ...
                     <div class="item">
                        <div class="car-item text-center">
                           <div class="car-image">
                              <img class="img-responsive" src="{{ asset('images/car/01.jpg') }}" alt="" />
                              <div class="car-overlay-banner">
                                 <ul>
                                    <li><a href="#"><i class="fa fa-link"></i></a></li>
                                    <li><a href="#"><i class="fa fa-dashboard"></i></a></li>
                     ...
                     <div class="item">
                        <div class="car-item text-center">
                           <div class="car-image">
                              <img class="img-responsive" src="{{ asset('images/car/05.jpg') }}" alt="" />
                              <div class="car-overlay-banner">
                                 <ul>
                                    <li><a href="#"><i class="fa fa-link"></i></a></li>
                                    <li><a href="#"><i class="fa fa-dashboard"></i></a></li>
               ...
               <div class="col-lg-12 col-md-12">
                  <div class="owl-carousel-2">
                     <div class="item">
                        <div class="testimonial-block text-center border-new">
                           <div class="testimonial-image">
                              <img class="img-responsive" src="{{ asset('images/testimonial/01.jpg') }}" alt="" />
                           </div>
                     ...
                     <div class="item">
                        <div class="testimonial-block text-center border-new">
                           <div class="testimonial-image">
                              <img class="img-responsive" src="{{ asset('images/testimonial/02.jpg') }}" alt="" />
                           </div>
                           <div class="testimonial-box">
                              <div class="testimonial-avtar">
                     ...
                     <div class="item">
                        <div class="testimonial-block text-center border-new">
                           <div class="testimonial-image">
                              <img class="img-responsive" src="{{ asset('images/testimonial/03.jpg') }}" alt="" />
                           </div>
                           <div class="testimonial-box">
                              <div class="testimonial-avtar">
                     ...
                     <div class="item">
                        <div class="testimonial-block text-center border-new">
                           <div class="testimonial-image">
                              <img class="img-responsive" src="{{ asset('images/testimonial/04.jpg') }}" alt="" />
                           </div>
                           <div class="testimonial-box">
                              <div class="testimonial-avtar">
            ...
            <div class="row">
               ...
               <div class="col-lg-3 col-md-3 col-sm-6">
                  <div class="recent-post-block">
                     ...
                     <div class="recent-post">
                        <div class="recent-post-image">
                           <img class="img-responsive" src="{{ asset('images/car/03.jpg') }}" alt="">
                        </div>
                        <div class="recent-post-info">
