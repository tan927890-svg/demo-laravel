    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 mr-4">Đăng nhập</a>
                    <a href="{{ route('register') }}" class="text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900">Đăng ký</a>
                @endauth
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @else
            <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600 px-4 space-y-1">
                <a href="{{ route('login') }}" class="block text-sm text-gray-700 py-2">Đăng nhập</a>
                <a href="{{ route('register') }}" class="block text-sm text-gray-700 py-2">Đăng ký</a>
            </div>
        @endguest
    </div>
</nav>